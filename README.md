...
* First sign into the AWS [console](https://aws.amazon.com/console/). If you have never used AWS you will have to sign up for an account, where you'll have to put in credit card info: don't worry, you get 1 million requests and 400,000GB-seconds of compute time per month for free, so don't worry about being charged for now. HOWEVER, you will be charged after the free trial ends because AWS will sign you up for their services automatically. They will send you an email shortly before they charge you, but I recommend to cancel your subscription soon after you give this a shot to avoid fees. 
